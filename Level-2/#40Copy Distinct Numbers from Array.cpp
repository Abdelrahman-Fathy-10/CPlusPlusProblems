...
// Program Name: Copy Distinct Numbers from Array
// Purpose: Copies only distinct (non-duplicate) numbers from a predefined source array into a destination array.
